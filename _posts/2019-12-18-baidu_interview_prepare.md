...
## 3.32 `C++11`中的可变参数模板、右值引用和`lambda`
- 可变参数模板：
...
按照Linux程序内存管理；new delect[] 之类的来说就行了；构造函数，析构函数；智能指针。
...
- `top`命令查看进程以及资源使用的情况
  ...
  - ![](https://user-images.githubusercontent.com/3783096/55340375-22334d00-54d7-11e9-8f4f-b96d3d727c54.png)
