...
您好，我叫王鹏程；现在正在四川大学计算机学院就读研究生二年级;研究生阶段主要使用语言是c++，之前主要的项目是老师所带领的一个校园无人公交车的项目；我主要在里面负责车辆监控客户端和轻量级的HTTP图像采集传输服务器。后期的主要精力还是在轻量图像传输服务器，也由此开始网络编程和后台开发感兴趣。想要尝试后端开发的实习，进一步学习后台开发相关的知识。
